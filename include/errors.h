...
#define INVALID_START_ADDRESS                                                  \
	"The allocated address is outside the size of arena\n"
...
#define WARNING_WRITE_SIZE                                                     \
	"size was bigger than the block size. Writing %ld characters.\n"
#define WARNING_READ_SIZE                                                      \
	"size was bigger than the block size. Reading %ld characters.\n"
